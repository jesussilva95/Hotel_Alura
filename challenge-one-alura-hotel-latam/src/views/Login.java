...
public class Login extends JFrame {
	...
	public Login() {
		...
		txtClave.setForeground(SystemColor.activeCaptionBorder);
		txtClave.setFont(new Font("Roboto", Font.PLAIN, 16));
		txtClave.setBorder(javax.swing.BorderFactory.createEmptyBorder());
		txtClave.setBounds(65, 353, 324, 32);
		panel.add(txtClave);
...
// Autenticacion del usuario para llamar la views de MenuUsuario
	private void Login() {
		 String User = "admin";
	     String Clave = "admin";

	        String contrase = new String (txtClave.getPassword());

	        if(txtUsuario.getText().equals(User) && contrase.equals(Clave)){
