...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		//boton de buscar reservas por num de reservas
		...
		btnEliminar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				}else {JOptionPane.showMessageDialog(null, "Error fila no seleccionada, por favor realice una busqueda y seleccione una fila para eliminar");
	...
	private void LlenarTablaReservaId() {
		...
		try {
			for (Reserva reservas : reserva) {
				modelo.addRow(new Object[] { reservas.getId(), reservas.getFechaE(), reservas.getFechaE(), reservas.getValor(), reservas.getFormaPago() });
			}
		} catch (Exception e) {
			throw e;
		}
	...
	private void LlenarTablasReservas() {
